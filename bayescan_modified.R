...
# plot
plot(log10(res[,colq]),res[,colfstat],xlim=rev(range(0,-2.25)),xlab="log10 (q value)",ylab=names(res[colfstat]),type="n")
...
lines(c(log10(FDR),log10(FDR)),c(-1,1),lty=2,lwd=2)
lines(c(log10(.01),log10(.01)),c(-1,1),lwd=2)
